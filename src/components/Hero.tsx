    ...
    return (
        <section id="home"
            ...
            <div className="h-full flex flex-col justify-center">
                ...
                {/*     className="border-4 border-red-400 pt-6 md:pt-0 min-w-full md:min-w-[55vw] md:min-h-[84vh] md:absolute md:right-0 md:top-32 pointer-events-none">*/}
                {/*    <canvas id="displayContent" className="block w-full h-full"></canvas>*/}
                {/*</div>*/}
